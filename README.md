...
We can run memory_graph in the browser using Pyodide: <a href="https://raw.githubusercontent.com/bterwijn/memory_graph/main/src/pyodide.html" target="_blank">pyodide-example</a>
